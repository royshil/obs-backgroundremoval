...
class MediaPipeLandscapeNcnnPipeline : public IRenderingPipeline {
public:
	static constexpr std::int32_t kPipelineId = 62828;

	MediaPipeLandscapeNcnnPipeline(const FilterProperty &property, obs_source_t *source,
	...
	~MediaPipeLandscapeNcnnPipeline() noexcept override;

	MediaPipeLandscapeNcnnPipeline(const MediaPipeLandscapeNcnnPipeline &) = delete;
	MediaPipeLandscapeNcnnPipeline(MediaPipeLandscapeNcnnPipeline &&) = delete;
	auto operator=(const MediaPipeLandscapeNcnnPipeline &) -> MediaPipeLandscapeNcnnPipeline & = delete;
	auto operator=(MediaPipeLandscapeNcnnPipeline &&) -> MediaPipeLandscapeNcnnPipeline & = delete;
...
private:
	...
	Effects::BackgroundRemovalEffect &backgroundRemovalEffect_;
...
class MediaPipeLandscapeNcnnCpuForcedPipeline final : public MediaPipeLandscapeNcnnPipeline {
public:
	static constexpr std::int32_t kPipelineId = 61563;

	using MediaPipeLandscapeNcnnPipeline::MediaPipeLandscapeNcnnPipeline;
